    ...
    <DashboardLayout title="Students">
      <div className="space-y-6">
        ...
        <CourseSelector
          ...
          courses={courses}
          label="Select Course"
          description="Choose which course to view students for"
        />
          ...
          <>
            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-4">
                <div className="relative">
                  ...
                  <Input 
                    placeholder={`Search students in ${COURSE_DISPLAY_NAMES[selectedCourse?.code || ''] || 'this course'}...`}
                    className="pl-10"
                  />
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Students enrolled in {COURSE_DISPLAY_NAMES[selectedCourse?.code || ''] || 'this course'}
                </CardDescription>
              </CardHeader>
              <CardContent>
